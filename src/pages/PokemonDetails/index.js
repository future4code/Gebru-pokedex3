    ...
    <main className='container'>
      <div className='container-card'>
        <div className='first-container'>
          {selectPokemon && (
            <img
              alt='Imagem pokemon de frente'
              src={selectPokemon.sprites.front_default}
            />
          )}
          {selectPokemon && (
            <img
              alt='Imagem pokemon de costas'
        ...
        <div className='thre-container-child'>
          ...
          <div>
            {selectPokemon &&
              selectPokemon.stats.map(poderes => {
                return (
                  <p>
        ...
        <div className='for-container-child'>
          ...
          <div>
            {selectPokemon &&
              selectPokemon.moves.map(ataque => {
                return <p>{ataque.move.name}</p>
              })}
          </div>
        </div>
